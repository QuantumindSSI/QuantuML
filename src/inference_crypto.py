#!/usr/bin/env python3
"""
Local Inference Script for Quantum-Resistant Cryptographic Protocol Analyzer
Supports interactive and batch modes for vulnerability analysis.
"""
...
def interactive_mode(model, tokenizer, cfg: dict):
    ...
    print("\n" + "=" * 60)
    print("Quantum-Resistant Cryptographic Protocol Analyzer")
    print("=" * 60)
    print("Paste a protocol description and implementation code, or type 'exit' to quit.\n")

    inf_cfg = cfg.get("inference", {})

    system_prompt = (
        "You are a Quantum-Resistant Cryptographic Protocol Analyzer. "
        "Your task is to analyze cryptographic protocol implementations, identify quantum-vulnerable patterns, "
        "classify the vulnerability type, explain the quantum attack vector, and recommend specific mitigations aligned with NIST PQC standards.\n\n"
    )
...
def main():
    parser = argparse.ArgumentParser(description="Inference for Quantum-Resistant Crypto Protocol Analyzer")
    ...
    parser.add_argument("--output_file", type=str, default="./outputs/evaluations/generations_crypto.json")
